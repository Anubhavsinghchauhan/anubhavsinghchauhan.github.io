...
export function Skills() {
  return (
    <section id="skills" className="section border-y border-white/[.06] bg-white/[.015]">
      <div className="shell">
        <Reveal><SectionHeading number="02" eyebrow="Capabilities" title="A practical AI toolkit." copy="Selected technologies I use to take ideas through data, modeling, APIs, and deployment." /></Reveal>
